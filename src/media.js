...
export const CEILING_TYPES = [
  ...
  },
  {
    ...
    alt: "Acoustic fabric ceiling, micro-perforation",
...
export const SYSTEM_TYPES = [
  {
    label: "Architectural Light Lines",
    img: "/projects/project-1.png",
    alt: "Linear LED light lines integrated in ceiling",
    copy: "Profiles 8–20 mm, CRI 90+, dim-to-warm options.",
  },
  {
  ...
  {
    label: "Flush-Mounted Spots",
    img: "/projects/project-1.png",
    alt: "Flush recessed luminaires",
    copy: "Luminaires sit perfectly flush with the stretch membrane.",
  },
  {
    label: "Curved/Radius Profiles",
    img: "/projects/project-6.png",
    alt: "Curved profile with sculpted forms",
    copy: "Smooth radiuses for organic shapes and continuous flow lines.",
  },
];
